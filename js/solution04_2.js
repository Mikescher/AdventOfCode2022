    ...
    Label1: do {
      ...
      Label2: do {
          ...
          if (!(i_469762155 < L_469762156)) break Label3;
            ...
            if ((((sec1s_469762103 <= sec2s_469762105) && (sec2s_469762105 <= sec1e_469762104)) || ((sec1s_469762103 <= sec2e_469762106) && (sec2e_469762106 <= sec1e_469762104)))) {
            ctr_469762054 = addInt(ctr_469762054, 1);
            rawEcho(makeNimstrLit("["), HEX24_335544323(sec2s_469762105), makeNimstrLit(".."), HEX24_335544323(sec2e_469762106), makeNimstrLit("]"), makeNimstrLit(" overlaps "), makeNimstrLit("["), HEX24_335544323(sec1s_469762103), makeNimstrLit(".."), HEX24_335544323(sec1e_469762104), makeNimstrLit("]"));
            }
            else {
            if ((((sec2s_469762105 <= sec1s_469762103) && (sec1s_469762103 <= sec2e_469762106)) || ((sec2s_469762105 <= sec1e_469762104) && (sec1e_469762104 <= sec2e_469762106)))) {
            ctr_469762054 = addInt(ctr_469762054, 1);
            rawEcho(makeNimstrLit("["), HEX24_335544323(sec2s_469762105), makeNimstrLit(".."), HEX24_335544323(sec2e_469762106), makeNimstrLit("]"), makeNimstrLit(" overlaps "), makeNimstrLit("["), HEX24_335544323(sec1s_469762103), makeNimstrLit(".."), HEX24_335544323(sec1e_469762104), makeNimstrLit("]"));
            }
            else {
            rawEcho(makeNimstrLit("["), HEX24_335544323(sec1s_469762103), makeNimstrLit(".."), HEX24_335544323(sec1e_469762104), makeNimstrLit("]"), makeNimstrLit(" nolap "), makeNimstrLit("["), HEX24_335544323(sec2s_469762105), makeNimstrLit(".."), HEX24_335544323(sec2e_469762106), makeNimstrLit("]"));
            }
            }
...
function js_run04_2() {
  ...
  BeforeRet: do {
    result_469762152 = toJSStr(run04_2_469762051());
    break BeforeRet;
  } while (false);
